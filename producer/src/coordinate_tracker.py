...
class CoordinateTracker:
    def __init__(self, initial_latitude, initial_longitude, initial_speed, initial_direction):
...
tracker = CoordinateTracker(initial_coordinates['latitude'], initial_coordinates['longitude'], initial_speed, initial_direction)
